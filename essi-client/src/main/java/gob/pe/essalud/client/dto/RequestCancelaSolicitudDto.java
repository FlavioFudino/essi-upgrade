...
@Data
public class RequestCancelaSolicitudDto extends BaseDto {
    ...
    @NotNull(message = "El número de solicitud es un dato obligatorio, verifique que contengan datos númericos.")
    @Pattern(regexp = "^[0-9]*", message = "El número de solicitud es un dato obligatorio, verifique que contengan datos númericos.")
